...
import com.example.vknewclient.CommentsViewModel
import com.example.vknewclient.CommentsViewModelFactory
...
fun CommentsScreen(
    ...
    val screenState = viewModel.state.observeAsState(CommentsScreenState.Initial)
